...
var format_pavee_15 = new ol.format.GeoJSON();
var features_pavee_15 = format_pavee_15.readFeatures(json_pavee_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_pavee_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_pavee_15.addFeatures(features_pavee_15);
var lyr_pavee_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_pavee_15, 
                style: style_pavee_15,
                popuplayertitle: "pavee",
                interactive: true,
                    title: '<img src="styles/legend/pavee_15.png" /> pavee'
                });
var format_Pistes_16 = new ol.format.GeoJSON();
var features_Pistes_16 = format_Pistes_16.readFeatures(json_Pistes_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Pistes_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Pistes_16.addFeatures(features_Pistes_16);
var lyr_Pistes_16 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Pistes_16, 
                style: style_Pistes_16,
                popuplayertitle: "Pistes",
                interactive: true,
                    title: '<img src="styles/legend/Pistes_16.png" /> Pistes'
                });
var format_Mosque_17 = new ol.format.GeoJSON();
var features_Mosque_17 = format_Mosque_17.readFeatures(json_Mosque_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Mosque_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Mosque_17.addFeatures(features_Mosque_17);
var lyr_Mosque_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Mosque_17, 
                style: style_Mosque_17,
                popuplayertitle: "Mosquée",
                interactive: true,
                title: '<img style="max-width:16px; max-height:16px;" src="styles/place_of_worship_islamic3.svg" /> Mosquée'
            });
var format_Lampesolaire_18 = new ol.format.GeoJSON();
var features_Lampesolaire_18 = format_Lampesolaire_18.readFeatures(json_Lampesolaire_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Lampesolaire_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Lampesolaire_18.addFeatures(features_Lampesolaire_18);
var lyr_Lampesolaire_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Lampesolaire_18, 
                style: style_Lampesolaire_18,
...
var format_lampelectrique_19 = new ol.format.GeoJSON();
var features_lampelectrique_19 = format_lampelectrique_19.readFeatures(json_lampelectrique_19, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_lampelectrique_19 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_lampelectrique_19.addFeatures(features_lampelectrique_19);
var lyr_lampelectrique_19 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_lampelectrique_19, 
                style: style_lampelectrique_19,
...
var format_Petitesboutiques_20 = new ol.format.GeoJSON();
var features_Petitesboutiques_20 = format_Petitesboutiques_20.readFeatures(json_Petitesboutiques_20, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Petitesboutiques_20 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Petitesboutiques_20.addFeatures(features_Petitesboutiques_20);
var lyr_Petitesboutiques_20 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Petitesboutiques_20, 
                style: style_Petitesboutiques_20,
                popuplayertitle: "Petites boutiques",
                interactive: true,
                    title: '<img src="styles/legend/Petitesboutiques_20.png" /> Petites boutiques'
                });
var format_banc_21 = new ol.format.GeoJSON();
var features_banc_21 = format_banc_21.readFeatures(json_banc_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_banc_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_banc_21.addFeatures(features_banc_21);
var lyr_banc_21 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_banc_21, 
                style: style_banc_21,
                popuplayertitle: "banc",
                interactive: true,
                    title: '<img src="styles/legend/banc_21.png" /> banc'
                });
var format_panneaux_22 = new ol.format.GeoJSON();
var features_panneaux_22 = format_panneaux_22.readFeatures(json_panneaux_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_panneaux_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_panneaux_22.addFeatures(features_panneaux_22);
var lyr_panneaux_22 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_panneaux_22, 
                style: style_panneaux_22,
                popuplayertitle: "panneaux",
                interactive: true,
                    title: '<img src="styles/legend/panneaux_22.png" /> panneaux'
                });

lyr_OpenStreetMap_0.setVisible(true);lyr_amenagements_1.setVisible(true);lyr_UGB_2.setVisible(true);lyr_Campuspedagogique_3.setVisible(true);lyr_Arbre_4.setVisible(true);lyr_CONTOURUGB_5.setVisible(true);lyr_Couchefermeagricole_6.setVisible(true);lyr_ParkingRectorat_7.setVisible(true);lyr_Boutiquesetrestosprivs_8.setVisible(true);lyr_Maisons_d_l_universite_9.setVisible(true);lyr_Restaurants_universitaire_10.setVisible(true);lyr_village_11.setVisible(true);lyr_Espacesportif_12.setVisible(true);lyr_allee_village_13.setVisible(true);lyr_Routesgoudronnees_14.setVisible(true);lyr_pavee_15.setVisible(true);lyr_Pistes_16.setVisible(true);lyr_Mosque_17.setVisible(true);lyr_Lampesolaire_18.setVisible(true);lyr_lampelectrique_19.setVisible(true);lyr_Petitesboutiques_20.setVisible(true);lyr_banc_21.setVisible(true);lyr_panneaux_22.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_amenagements_1,lyr_UGB_2,lyr_Campuspedagogique_3,lyr_Arbre_4,lyr_CONTOURUGB_5,lyr_Couchefermeagricole_6,lyr_ParkingRectorat_7,lyr_Boutiquesetrestosprivs_8,lyr_Maisons_d_l_universite_9,lyr_Restaurants_universitaire_10,lyr_village_11,lyr_Espacesportif_12,lyr_allee_village_13,lyr_Routesgoudronnees_14,lyr_pavee_15,lyr_Pistes_16,lyr_Mosque_17,lyr_Lampesolaire_18,lyr_lampelectrique_19,lyr_Petitesboutiques_20,lyr_banc_21,lyr_panneaux_22];
lyr_amenagements_1.set('fieldAliases', {'NAME': 'NAME', 'TYPE': 'TYPE', 'Superficie': 'Superficie', });
lyr_UGB_2.set('fieldAliases', {'NAME': 'NAME', 'Code': 'Code', 'village': 'village', 'emplacemen': 'emplacemen', 'type': 'type', 'numero': 'numero', 'occupants': 'occupants', 'nbre_palie': 'nbre_palie', 'nbre_occup': 'nbre_occup', 'douche_int': 'douche_int', 'nbre_douch': 'nbre_douch', 'salle_tv': 'salle_tv', 'nbre_salle': 'nbre_salle', 'salle_tv_h': 'salle_tv_h', 'salle_etud': 'salle_etud', 'nbre_sal_1': 'nbre_sal_1', 'nbre_toile': 'nbre_toile', 'nbre_chamb': 'nbre_chamb', 'nbre_conci': 'nbre_conci', 'concierger': 'concierger', 'nbre_debar': 'nbre_debar', 'un_debarra': 'un_debarra', 'bureau_adm': 'bureau_adm', 'bureau_cv': 'bureau_cv', 'bureau_cv_': 'bureau_cv_', 'chambres _': 'chambres _', 'mosquee_da': 'mosquee_da', 'mosquee_ho': 'mosquee_ho', 'name_2': 'name_2', 'amenity': 'amenity', 'name_3': 'name_3', 'NAME_4': 'NAME_4', 'LIEU': 'LIEU', 'NAME_5': 'NAME_5', 'LAYER': 'LAYER', 'KML_STYLE': 'KML_STYLE', 'tessellate': 'tessellate', 'name_6': 'name_6', 'Nom': 'Nom', 'Superficie': 'Superficie', 'NAME_7': 'NAME_7', 'LIEU_2': 'LIEU_2', 'NAME_8': 'NAME_8', 'LIEU_3': 'LIEU_3', 'NAME_9': 'NAME_9', 'LIEU_4': 'LIEU_4', });
...
lyr_Routesgoudronnees_14.set('fieldAliases', {'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'highway': 'highway', 'ford': 'ford', 'footway': 'footway', 'level': 'level', 'layer': 'layer', 'covered': 'covered', 'tracktype': 'tracktype', 'noexit': 'noexit', 'junction': 'junction', 'access': 'access', 'width': 'width', 'lit': 'lit', 'service': 'service', 'oneway': 'oneway', 'surface': 'surface', 'ref': 'ref', 'nat_ref': 'nat_ref', 'name': 'name', 'maxspeed': 'maxspeed', 'lanes': 'lanes', 'int_ref_ar': 'int_ref_ar', 'int_ref': 'int_ref', });
lyr_pavee_15.set('fieldAliases', {'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'highway': 'highway', 'ford': 'ford', 'footway': 'footway', 'level': 'level', 'layer': 'layer', 'covered': 'covered', 'tracktype': 'tracktype', 'noexit': 'noexit', 'junction': 'junction', 'access': 'access', 'width': 'width', 'lit': 'lit', 'service': 'service', 'oneway': 'oneway', 'surface': 'surface', 'ref': 'ref', 'nat_ref': 'nat_ref', 'name': 'name', 'maxspeed': 'maxspeed', 'lanes': 'lanes', 'int_ref_ar': 'int_ref_ar', 'int_ref': 'int_ref', });
lyr_Pistes_16.set('fieldAliases', {'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'highway': 'highway', 'ford': 'ford', 'footway': 'footway', 'level': 'level', 'layer': 'layer', 'covered': 'covered', 'tracktype': 'tracktype', 'noexit': 'noexit', 'junction': 'junction', 'access': 'access', 'width': 'width', 'lit': 'lit', 'service': 'service', 'oneway': 'oneway', 'surface': 'surface', 'ref': 'ref', 'nat_ref': 'nat_ref', 'name': 'name', 'maxspeed': 'maxspeed', 'lanes': 'lanes', 'int_ref_ar': 'int_ref_ar', 'int_ref': 'int_ref', });
lyr_Mosque_17.set('fieldAliases', {'id': 'id', 'Name': 'Name', });
lyr_Lampesolaire_18.set('fieldAliases', {'Point': 'Point', 'Latitude': 'Latitude', 'Longitude': 'Longitude', });
lyr_lampelectrique_19.set('fieldAliases', {'id': 'id', });
lyr_Petitesboutiques_20.set('fieldAliases', {'NAME': 'NAME', 'LIEU': 'LIEU', 'TYPE': 'TYPE', 'SERVICE': 'SERVICE', });
lyr_banc_21.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'ETAT__': 'ETAT__', 'COMPOSITIO': 'COMPOSITIO', });
lyr_panneaux_22.set('fieldAliases', {'Field1': 'Field1', 'Field2': 'Field2', 'Field3': 'Field3', 'Field4': 'Field4', 'Field5': 'Field5', 'Field6': 'Field6', 'Field7': 'Field7', });
lyr_amenagements_1.set('fieldImages', {'NAME': 'TextEdit', 'TYPE': 'TextEdit', 'Superficie': '', });
lyr_UGB_2.set('fieldImages', {'NAME': '', 'Code': '', 'village': '', 'emplacemen': '', 'type': '', 'numero': '', 'occupants': '', 'nbre_palie': '', 'nbre_occup': '', 'douche_int': '', 'nbre_douch': '', 'salle_tv': '', 'nbre_salle': '', 'salle_tv_h': '', 'salle_etud': '', 'nbre_sal_1': '', 'nbre_toile': '', 'nbre_chamb': '', 'nbre_conci': '', 'concierger': '', 'nbre_debar': '', 'un_debarra': '', 'bureau_adm': '', 'bureau_cv': '', 'bureau_cv_': '', 'chambres _': '', 'mosquee_da': '', 'mosquee_ho': '', 'name_2': '', 'amenity': '', 'name_3': '', 'NAME_4': '', 'LIEU': '', 'NAME_5': '', 'LAYER': '', 'KML_STYLE': '', 'tessellate': '', 'name_6': '', 'Nom': '', 'Superficie': '', 'NAME_7': '', 'LIEU_2': '', 'NAME_8': '', 'LIEU_3': '', 'NAME_9': '', 'LIEU_4': '', });
...
lyr_Routesgoudronnees_14.set('fieldLabels', {'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'ford': 'no label', 'footway': 'no label', 'level': 'no label', 'layer': 'no label', 'covered': 'no label', 'tracktype': 'no label', 'noexit': 'no label', 'junction': 'no label', 'access': 'no label', 'width': 'no label', 'lit': 'no label', 'service': 'no label', 'oneway': 'no label', 'surface': 'no label', 'ref': 'no label', 'nat_ref': 'no label', 'name': 'no label', 'maxspeed': 'no label', 'lanes': 'no label', 'int_ref_ar': 'no label', 'int_ref': 'no label', });
lyr_pavee_15.set('fieldLabels', {'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'ford': 'no label', 'footway': 'no label', 'level': 'no label', 'layer': 'no label', 'covered': 'no label', 'tracktype': 'no label', 'noexit': 'no label', 'junction': 'no label', 'access': 'no label', 'width': 'no label', 'lit': 'no label', 'service': 'no label', 'oneway': 'no label', 'surface': 'no label', 'ref': 'no label', 'nat_ref': 'no label', 'name': 'no label', 'maxspeed': 'no label', 'lanes': 'no label', 'int_ref_ar': 'no label', 'int_ref': 'no label', });
lyr_Pistes_16.set('fieldLabels', {'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'ford': 'no label', 'footway': 'no label', 'level': 'no label', 'layer': 'no label', 'covered': 'no label', 'tracktype': 'no label', 'noexit': 'no label', 'junction': 'no label', 'access': 'no label', 'width': 'no label', 'lit': 'no label', 'service': 'no label', 'oneway': 'no label', 'surface': 'no label', 'ref': 'no label', 'nat_ref': 'no label', 'name': 'no label', 'maxspeed': 'no label', 'lanes': 'no label', 'int_ref_ar': 'no label', 'int_ref': 'no label', });
lyr_Mosque_17.set('fieldLabels', {'id': 'no label', 'Name': 'inline label - visible with data', });
lyr_Lampesolaire_18.set('fieldLabels', {'Point': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', });
lyr_lampelectrique_19.set('fieldLabels', {'id': 'no label', });
lyr_Petitesboutiques_20.set('fieldLabels', {'NAME': 'inline label - visible with data', 'LIEU': 'inline label - visible with data', 'TYPE': 'no label', 'SERVICE': 'inline label - visible with data', });
lyr_banc_21.set('fieldLabels', {'X': 'no label', 'Y': 'no label', 'ETAT__': 'no label', 'COMPOSITIO': 'no label', });
lyr_panneaux_22.set('fieldLabels', {'Field1': 'no label', 'Field2': 'no label', 'Field3': 'no label', 'Field4': 'no label', 'Field5': 'no label', 'Field6': 'no label', 'Field7': 'no label', });
lyr_panneaux_22.on('precompose', function(evt) {
